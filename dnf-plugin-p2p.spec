...
Provides:       libdnf5-plugin-p2p-sharing = %{version}-%{release}
Provides:       python3-libdnf5-plugin-p2p-sharing = %{version}-%{release}
Obsoletes:      libdnf5-plugin-p2p-sharing < %{version}-%{release}
...
Summary:        Common Python modules for dnf-plugin-p2p
BuildArch:      noarch
Provides:       python3-libdnf-p2p-sharing-common = %{version}-%{release}
Obsoletes:      python3-libdnf-p2p-sharing-common < %{version}-%{release}
...
%changelog
* Sun Jun 21 2026 dnf-plugin-p2p contributors <none@example.com> - 0.3.2-1
- Release 0.3.2

* Sun Jun 21 2026 dnf-plugin-p2p contributors <none@example.com> - 0.3.1-1
- Release 0.3.1

* Sun Jun 21 2026 dnf-plugin-p2p contributors <none@example.com> - 0.3.0-1
- Release 0.3.0

* Fri Jun 19 2026 dnf-plugin-p2p contributors <none@example.com> - 0.2.1-1
- Release 0.2.1
